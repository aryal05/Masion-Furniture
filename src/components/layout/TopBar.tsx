...
export function TopBar() {
  return (
    <m.div
      className="hidden md:block bg-primary text-white text-xs sm:text-sm fixed inset-x-0 top-0 z-[60]"
      style={{ height: 'var(--topbar-height, 32px)' }}
    ...
    >
      <div className="max-w-[1600px] mx-auto h-full flex items-center justify-between px-4 sm:px-6 md:px-10 lg:px-16">
        ...
        <div className="hidden md:flex items-center gap-1.5 text-center">
          ...
          <span className="font-bold">GET 25% OFF</span>
          <span>for your first order.</span>
          <a
            href="/signup"
            className="underline underline-offset-2 text-gold hover:text-white transition-colors font-medium ml-1"
          >
            Sign up now
          </a>
        </div>
